...
export default function MessageBlock({ message, role, rows, reverse }: MessageBlockProps) {
    ...
    return (
        <div className={`flex flex-col space-y-2 pt-[3%] ${isAssistantMessage ? '' : 'items-end'}`}>
            ...
            {rows && rows.length > 0 && (
                <div className={`w-full ${isAssistantMessage ? '' : 'flex justify-end'}`}>
                    <Table>
                        <TableHeader>
                            <TableRow>
